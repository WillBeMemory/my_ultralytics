...
if __name__ == "__main__":
    # ==================== 配置区域（直接修改变量即可）====================
    # 源目录
    source_images = r"D:\Study\10_dataset\HRSID_COMPLEX\images\others"   # 你的原始图片文件夹
    source_labels = r"D:\Study\10_dataset\HRSID_COMPLEX\labels\others"   # 你的原始标签文件夹
    # 输出根目录（会在其下创建 images/train, images/test, labels/train, labels/test）
    output_base = r"D:\Study\10_dataset\HRSID_COMPLEX\others"                 # 例如 datasets
