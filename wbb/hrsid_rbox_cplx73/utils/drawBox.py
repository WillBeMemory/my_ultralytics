...
# ==================== 用户可修改参数 ====================
IMAGE_FOLDER = r"D:\Study\10_dataset\HRSID_YOLO\images\val"   # 图像文件夹路径
LABEL_FOLDER = r"D:\Study\10_dataset\HRSID_YOLO\labels\val"   # 标注文件夹路径（与图像同名 .txt）
OUTPUT_FOLDER = r"D:\Study\10_dataset\HRSID_YOLO\obb\draw\val"     # 输出文件夹路径
