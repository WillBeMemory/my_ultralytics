"""LS-SSDD WEF-YOLO eval script with detailed metrics: AP50/AP70/AP95, APS/APM/APL.

Usage:
    cd wbb/lsssdd
    python eval_lsssdd_WEF.py
    python eval_lsssdd_WEF.py --run_name train2
"""
import argparse
import json
import os
...
def parse_args():
    p = argparse.ArgumentParser(description="LS-SSDD detailed eval script")
