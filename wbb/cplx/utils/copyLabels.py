...
if __name__ == "__main__":
    # ==================== 配置区域 ====================
    # 请根据你的实际路径修改以下变量
    image_folder = r"D:\Study\10_dataset\HRSID_YOLO_COMPLEX\images\val"  # 已筛选图片所在的文件夹
    label_source_folder = r"D:\Study\10_dataset\HRSID_YOLO\labels\val"  # 存放所有YOLO标注txt的文件夹
    label_target_folder = r"D:\Study\10_dataset\HRSID_YOLO_COMPLEX\labels\val"  # 要复制标注的目标文件夹
    # ==================================================
