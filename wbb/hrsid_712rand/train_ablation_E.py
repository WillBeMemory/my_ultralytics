# train_ablation_E.py — WEF-YOLO 消融变体 E (+SFEE P4 边缘增强)
# 模型: yolo11s-ablation-E.yaml (scale s); 数据集: HRSID 712rand(主划分,3923/560/1121)
...
MODEL_NAME = "yolo11s-ablation-E.yaml"
