# train_hrsid_yolo11s-test.py — Ours (yolo11s-test.yaml), 完全随机 7:1:2 划分
# 由 hrsid_712/ 复制，仅改 DATASET_PATH=hrsid_712rand.yaml。
# 数据集: HRSID_YOLO_712rand  3923 train / 560 val / 1121 test (全 pool 随机分)
# 用途: 验证 7:1:2 性能差是划分运气 vs train 量少。

from ultralytics import YOLO
import os
import torch

MODEL_NAME = "yolo11n-test.yaml"
