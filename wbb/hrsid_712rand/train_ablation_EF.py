# train_ablation_EF.py — WEF-YOLO 消融变体 EF (+SFEE +WRF)
# 模型: yolo11s-ablation-EF.yaml (scale s); 数据集: HRSID 712rand(主划分,3923/560/1121)
...
MODEL_NAME = "yolo11s-ablation-EF.yaml"
DATASET_PATH = "../cfg/hrsid_712rand.yaml"
RUN_NAME = "ablation_EF"
