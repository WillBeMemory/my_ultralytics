# train_ablation_WF.py — WEF-YOLO 消融变体 WF (+LWDS +WRF)
# 模型: yolo11s-ablation-WF.yaml (scale s); 数据集: HRSID 712rand(主划分,3923/560/1121)
...
MODEL_NAME = "yolo11s-ablation-WF.yaml"
DATASET_PATH = "../cfg/hrsid_712rand.yaml"
RUN_NAME = "ablation_WF"
