# train_ablation_F.py — WEF-YOLO 消融变体 F (+WRF 颈部加权再融合)
# 模型: yolo11s-ablation-F.yaml (scale s); 数据集: HRSID 712rand(主划分,3923/560/1121)
...
MODEL_NAME = "yolo11s-ablation-F.yaml"
