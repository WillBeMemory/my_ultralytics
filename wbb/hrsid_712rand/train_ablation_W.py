# train_ablation_W.py — WEF-YOLO 消融变体 W (+LWDS 去噪 stem)
# 模型: yolo11s-ablation-W.yaml (scale s); 数据集: HRSID 712rand(主划分,3923/560/1121)
...
MODEL_NAME = "yolo11s-ablation-W.yaml"
