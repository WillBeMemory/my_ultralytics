"""HRSID WEF-YOLO eval script with detailed metrics: AP50/AP70/AP95, APS/APM/APL.

Usage:
    cd wbb/hrsid_official
    python eval_hrsid_WEF.py
    python eval_hrsid_WEF.py --run_name train2
"""
import argparse
import json
import os
...
DATA_YAML = "../cfg/hrsid_official.yaml"
IMGSZ = 640
...
def parse_args():
    p = argparse.ArgumentParser(description="HRSID detailed eval script")
