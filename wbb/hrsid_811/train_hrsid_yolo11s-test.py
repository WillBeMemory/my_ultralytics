# train_hrsid_yolo11s-test.py — Ours (yolo11s-test.yaml, 完整模型), 8:1:1 划分
# 由 wbb/hrsid_712/train_hrsid_yolo11s-test.py 复制，仅改 DATASET_PATH，其余协议保持一致以保证 delta 可比。
# 数据集: HRSID_YOLO_811  4483 train / 560 val / 561 test
...
DATASET_PATH = "../cfg/hrsid_811.yaml"
